...
equiv(X,Y) -> do_equiv(strict, X, Y).
equiv_relaxed(X,Y) -> do_equiv(relaxed, X, Y).
...
do_equiv(M, true, true) -> true;
do_equiv(M, false, false) -> true;
do_equiv(M, null, null) -> true;
